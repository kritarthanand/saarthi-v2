...
export function MealLoggingSummary({ tasks, onToggleTask, readOnly = false }: SummaryViewProps) {
  const theme = threadTheme('#MealLog');
  ...
  const heroCopy =
      ...
      ? 'All meals tracked. Good discipline.'
      : done === 0
        ? 'Start logging as you eat.'
        : `${done} of ${total} logged — keep going.`;
